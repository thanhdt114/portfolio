...
function Footer(props) {
  ...
  return (
    <div className="bg-fourth w-full py-18 text-center">
      <h1 className="text-white text-4xl font-semibold">Johnny Tran</h1>
      ...
      <div className="flex justify-center mt-8">
        <a href={Links.github} target="_blank">
          <svg
            class="w-9 h-9 text-white hover:bg-white hover:text-fourth rounded-full cursor-pointer"
            aria-hidden="true"
      ...
      <p className="text-white text-sm mt-7">&#x24D2; Created by Johnny Tran</p>
    </div>
  );
}
